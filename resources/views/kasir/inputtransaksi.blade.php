...
@section('content')
    ...
    <div class="container col-5 mt-5 mb-5">
        <form action="{{ route('addtransaksikasir') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kode_invoice') is-invalid @enderror" name="kode_invoice"
                    value="{{ old('kode_invoice', $nomor) }}" readonly>
                @error('kode_invoice')
                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <a href="{{ route('transaksikasir') }}" class="btn btn-primary">Kembali</a>
